    ...
    <div class="col-12">
        <div class="card m-b-30">
            <div class="card-header">
                <h4 class="mt-0 header-title">Contact Us List</h4>
                <div class="card-header-actions d-none">
                    <button class="btn btn-success float-right" title="Add category" data-toggle="modal" data-target="#category_add_modal" data-id="'.$data->id.'">Add Sub Category</button>
                </div>
            </div>
            <div class="card-body">
            ...
            if (result) {
                $.ajax({
                    ...
                    success : function (res) {
                        ...
                        window.LaravelDataTables["subinterestcategory-table"].draw();
                    }
                });
            } else {
        ...
        $.ajax({
            ...
            success: function(result){
                ...
                if(result) {
                    ...
                    $('#category_edit_modal').find('#interest_category_id').val(result.interest_category_id);
                    $('#category_edit_modal').find('#interest_sub_category_name').val(result.interest_sub_category_name);
