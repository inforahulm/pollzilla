                                    ...
                                    <tr>
                                        <td align="center" style="padding-top: 40px;padding-bottom: 40px;">
                                            <div style="display: block">
                                                <h1 style="font-family: 'Work Sans';font-size:22px;font-weight: 700; color: #000000;margin:0;">Email Verification</h1>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div style="display: block">
                                                            ...
                                                            <p style="font-family: 'Work Sans';font-size:14px;font-weight: 400;line-height: 20px;color: #292929;margin:0;margin-bottom: 10px;">We have received registration request from {{ config('app.name') }} app.</p>
                                                            <p style="font-family: 'Work Sans';font-size:14px;font-weight: 400;line-height: 20px;color: #292929;margin:0;margin-bottom: 10px;">Please enter below code to verify your email id.</p>
                                                            ...
                                                            <p style="font-family: 'Work Sans';font-size:14px;font-weight: 400;line-height: 20px;color: #292929;margin:0;margin-bottom: 10px;">If you have not registered with us , Kindly ignore this and don't share your OTP/Password with anyone.</p>
                                                        </div>
                                                    </td>
                                                </tr>
                                            </table>
